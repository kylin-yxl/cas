        ...
        if(tgtId == null){
            ...
            if(cookies != null){
        		for(Cookie cookie : cookies){
        			if(cookie.getName().equals("checkTgt")){
        				tgtId = EncryptUtil.decrypt(cookie.getValue(),EncryptUtil.DEFAULT_TGT_KEY);
        				WebUtils.putTicketGrantingTicketIntoMap(requestContext.getRequestScope(), tgtId);
        				WebUtils.putTicketGrantingTicketIntoMap(requestContext.getFlowScope(), tgtId);
        			}
        		}
            }
        }
