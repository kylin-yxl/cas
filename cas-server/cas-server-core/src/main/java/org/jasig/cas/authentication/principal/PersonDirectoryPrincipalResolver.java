...
public class PersonDirectoryPrincipalResolver implements PrincipalResolver {
    ...
    public Principal resolve(final Credential credential) {
        ...
        attributes.put("code", Collections.singletonList((Object)usernamePasswordCredential.getCode()));
        attributes.put("name", Collections.singletonList((Object)usernamePasswordCredential.getName()));
        attributes.put("companyid", Collections.singletonList((Object)usernamePasswordCredential.getCompanyid()));
        attributes.put("companyname", Collections.singletonList((Object)usernamePasswordCredential.getCompanyname()));
        attributes.put("COMPANY_SHORT_NAME", Collections.singletonList((Object)usernamePasswordCredential.getCOMPANY_SHORT_NAME()));
        attributes.put("company_address", Collections.singletonList((Object)usernamePasswordCredential.getCompany_address()));
        attributes.put("phone", Collections.singletonList((Object)usernamePasswordCredential.getPhone()));
        attributes.put("user_id", Collections.singletonList((Object)usernamePasswordCredential.getUser_id()));
